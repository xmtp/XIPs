...
Identity updates for the inbox log defined in https://github.com/xmtp/XIPs/blob/main/XIPs/xip-46-multi-wallet-identity.md will be stored using the publish and query endpoints above. All nodes will continue to validate identity update payloads as defined in the XIP.
